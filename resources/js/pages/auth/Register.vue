        ...
        <form @submit.prevent="submit" class="flex flex-col gap-6">
            <div class="grid gap-6">
                ...
                <div class="grid gap-2">
                    ...
                    <Input id="last_name" type="text" required :tabindex="2" autocomplete="last_name" v-model="form.last_name" placeholder="Last name" />
                    <InputError :message="form.errors.last_name" />
                </div>

                <div class="grid gap-2">
                    <Label for="phone">Phone</Label>
                    <Input id="phone" type="text" :tabindex="3" autocomplete="phone" v-model="form.phone" placeholder="Phone" />
